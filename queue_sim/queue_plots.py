...
def plot_dispersion(input_folder1, input_folder2, input_folder3, input_file,
    ...
    total_ttis = 1000 # int((total_duration / tti_duration) / 2)
    ...
    if plot:
        ...
        plt.plot(x_axis, packets_per_tti1[0:int(total_ttis)], alpha=0.7, # '-s',
                  # label='20% Load')
                  label='5 Queues (1.0s)')
    
        # # plt.scatter(x_axis, packets_per_tti2[0:int(total_ttis)], marker='v',
        # #             s=100, label='50% Load')
        # plt.plot(x_axis, packets_per_tti2[0:int(total_ttis)], alpha=0.7, # '-*',
        #           # label='50% Load')
        #           label='10 Queues (1.0s)')
    
        # plt.scatter(x_axis, packets_per_tti3[0:int(total_ttis)], marker='o',
        #             s=100, label='90% Load')
        # plt.plot(x_axis, packets_per_tti3[0:int(total_ttis)], alpha=0.7, # '-o',
        #           # label='90% Load')
        #           label='15') 
...
input_folder1 = "5Q - 90.0% Load - 1Gbps - 1.0s - BG - 10.0us"
input_folder2 = "10Q - 50.0% Load - 1Gbps - 1.0s - BG - 10.0us"
input_folder3 = "15Q - 50.0% Load - 1Gbps - 1.0s - BG - 10.0us"
